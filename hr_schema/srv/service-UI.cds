...
annotate hr.Countries with @(
    ...
    UI.FieldGroup #CountryDetails: {Data: [
        ...
        {
            Value: region.Region_Name, // Assuming Region_Name is a column in Regions entity
            Label: 'Region Name'
        }
    ]}
);
...
annotate hr.Locations with @(
    ...
    UI.Facets                     : [{
        ...
        Target: '@UI.FieldGroup#LocationDetails' // Ensure that this matches the FieldGroup name
    }],
